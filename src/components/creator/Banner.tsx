  ...
  return (
    <div className='flex w-full relative'>
      <Image
        ...
        alt=''
        {...CREATOR_BANNER_SIZE}
        className='w-full rounded-xl aspect-creator-banner object-top object-cover sm:rounded-2xl sm:h-[300px]'
      />
      <AvatarImage
        src={creator.avatar}
        size='large'
        className='absolute w-[124px] h-[124px] max-sm:-bottom-7 max-sm:left-1/2 max-sm:transform max-sm:-translate-x-1/2 max-sm:w-20 max-sm:h-20 max-md:w-24 max-md:h-24 sm:-bottom-7 sm:left-4 '
      />
