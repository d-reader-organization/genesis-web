  ...
  return (
    <>
      ...
      >
        <div className='w-full mx-auto h-[72px] max-w-screen-xl flex items-center'>
          <div className='flex items-center justify-between max-w-screen-md mx-auto w-full'>
            <Link href={RoutePath.ComicIssue(comicIssue.id)} className={navigationLinkStyle}>
      ...
      {/* <div className='sm:hidden'>
        ...
        >
          <div className='w-full mx-auto h-[72px] max-w-screen-xl'>
            <div className='flex items-center justify-between max-w-screen-md mx-auto w-full'>{commands}</div>
          </div>
        </div>
      </div> */}

      {/* <div ref={pageBottomRef} className='absolute bottom-0 size-[72px]' /> */}
    </>
  )
}
