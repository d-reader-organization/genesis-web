...
export const BackgroundImageWithGradient: React.FC<Props> = ({ children, image }) => (
  <>
    ...
    >
      <div className='absolute left-0 right-0 bottom-0 top-auto -z-[1] bg-0-top bg-repeat-x size-full bg-[linear-gradient(180deg,rgba(21,23,28,1)_0%,rgba(21,23,28,0)_77.29%)]' />
    </div>
