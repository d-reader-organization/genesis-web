...
export const ConfirmingTransactionDialog: React.FC<CommonDialogProps> = ({ open, toggleDialog }) => {
  return (
    <Dialog open={open}>
      <DialogContent
        aria-describedby=''
      ...
      >
        ...
        <video
          className='rounded:[32px] sm:rounded-[64px] max-h-[300px] max-w-[300px] h-full w-full'
          autoPlay
          loop
          muted
        >
