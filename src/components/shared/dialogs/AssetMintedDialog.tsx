...
export const AssetMintedDialog: React.FC<Props> = ({ comicIssue, isAuthenticated, open, onClose }) => {
        ...
        <div className='flex flex-col items-center gap-6 relative w-full h-full min-h-16 mx-auto max-w-[444px] overflow-y-scroll p-6'>
          {asset ? (
            <>
              ...
              <Image src={asset.image} width={690} height={1000} alt='Comic' className='w-[400px] max-w-full h-auto' />
              ...
              <div className='flex flex-col gap-4 w-full'>
                ...
                <Button className='text-grey-50 border border-grey-50' onClick={onClose} variant='ghost'>
                  Close
                </Button>
              </div>
            </>
